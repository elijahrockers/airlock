...
STUDIES = [
    ...
    # --- Researcher-owned studies (requested_by=dev_user) across remaining statuses ---
    {
        "irb_pro_number": "PRO-2025-0021",
        "title": "Retinal OCT Deidentification",
        "description": "Deidentify retinal OCT scans for ophthalmology AI training.",
    ...
    {
        "irb_pro_number": "PRO-2024-0088",
        "title": "Chest X-Ray Federated Learning Study",
        "description": "Multi-site federated learning on deidentified chest X-rays.",
        "pi_name": "Dr. David Kim",
        "requestor": "Emily Rodriguez",
        "status": "active",
        "requested_by": "dev_user",
        "temporal_policy": TemporalPolicy.shifted,
        "expiration_alert_date": date.today() + timedelta(days=90),
    },
    {
        "irb_pro_number": "PRO-2023-0201",
        "title": "Mammography Screening Dataset",
        "description": "Completed deidentification of screening mammography images.",
        "pi_name": "Dr. Angela Torres",
        "status": "completed",
        "requested_by": "dev_user",
        "temporal_policy": TemporalPolicy.removed,
    },
    {
        "irb_pro_number": "PRO-2023-0150",
        "title": "Dermatology Image Archive",
        "description": "Archived dermatology image dataset — IRB approval expired.",
        "pi_name": "Dr. Kevin O'Brien",
        "status": "archived",
        "requested_by": "dev_user",
        "temporal_policy": TemporalPolicy.unshifted,
        "expiration_alert_date": date.today() - timedelta(days=90),
    ...
    {
        "irb_pro_number": "PRO-2025-0030",
        "title": "Genomics PHI Linkage Request",
        "description": "Rejected — insufficient IRB documentation for genomics data linkage.",
        "pi_name": "Dr. Rachel Nguyen",
        "status": "rejected",
        "requested_by": "dev_user",
        "temporal_policy": TemporalPolicy.removed,
    },
    # --- Broker-owned studies across remaining statuses ---
    {
        "irb_pro_number": "PRO-2024-0055",
        "title": "Emergency Dept CT Anonymization",
        "description": "Broker-initiated deidentification of emergency department CT data.",
        "pi_name": "Dr. Robert Chang",
        "requestor": "Maria Santos",
        "status": "completed",
        "temporal_policy": TemporalPolicy.shifted,
    },
    {
        "irb_pro_number": "PRO-2023-0099",
        "title": "Neonatal Ultrasound Archive",
        "description": "Archived neonatal ultrasound dataset, data retention period ended.",
        "pi_name": "Dr. Susan Mitchell",
        "status": "archived",
        "temporal_policy": TemporalPolicy.removed,
        "expiration_alert_date": date.today() - timedelta(days=180),
    },
    {
        "irb_pro_number": "PRO-2025-0008",
        "title": "Spine MRI Multi-Center Study",
        "description": "Rejected — duplicate of existing PRO-2024-0042.",
        "pi_name": "Dr. Thomas Lee",
        "status": "rejected",
        "temporal_policy": TemporalPolicy.unshifted,
    },
]
